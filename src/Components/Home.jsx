	...
	return (
		<Container>
			...
			<Grid>
				...
				<Grid.Col span={{ base: 12, md: 6, lg: 6 }}>
					<section id="Home-WhereDoIStart">
						<Card withBorder shadow="sm" radius="md">
							<Card.Section withBorder inheritPadding py="xs">
								Where do I start?
							</Card.Section>
							<Text mt="sm" c="dimmed" size="sm">
								Start by exploring the diagram, which maps out the key entities and
								their relationships, giving you a clear understanding of the data
								structure. Next, dive into the endpoints, each designed for efficient
								CRUD operations to manage resources seamlessly. This foundation ensures
								you are ready to test and integrate the API with confidence.
							</Text>
						</Card>
					</section>
				</Grid.Col>
